...
import DetailTitle from '../components/common/detail-title.component';
                      ...
                      >
                        {Array.isArray(reservableSaleProduct) &&
                          reservableSaleProduct.map((d) => (
                            <FormItem
                              key={d._id}
                              className="flex items-center space-x-3 space-y-0 bg-white p-3 rounded border border-gray-200"
                            >
                              <FormControl>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={() => (
                    <FormItem className="bg-gray-50 p-4 rounded-lg space-y-3">
                      <div>
                        <FormLabel className="text-base font-medium">
                          추가 옵션
                        </FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <FormDescription>
                        (현금 혹은 입금의 경우, 이 메모란에 세금계산서 및
                        현금영수증 발급여부와 발급하실 사업자번호 혹은
                        현금영수증 번호를 기재 부탁드립니다.)
                      </FormDescription>
                      <FormControl>
                        <div className="space-y-4">
                          <RadioGroup
                            onValueChange={(value) =>
                              field.onChange({
                                ...
                                memo: ['cashPayment', 'preDeposit'].includes(
                                  value
                                )
                                  ? field.value?.memo
                                  : '',
